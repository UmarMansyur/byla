...
<body>
              ...
              <div class="dropdown-menu py-0 dropdown-lg dropdown-menu-end"
                ...
                <div data-simplebar style="max-height: 280px;">
                  ...
                  <a href="javascript:void(0);" class="dropdown-item py-3 border-bottom text-wrap">
                    <div class="d-flex">
                      <div class="flex-shrink-0">
                        <img src="/admin/images/users/avatar-1.jpg" class="img-fluid me-2 avatar-sm rounded-circle"
                          alt="avatar-1" />
                      </div>
                      <div class="flex-grow-1">
                        <p class="mb-0"><span class="fw-medium">Josephine Thompson </span>commented on admin panel
                  ...
                  <a href="javascript:void(0);" class="dropdown-item py-3 border-bottom">
                    <div class="d-flex">
                      <div class="flex-shrink-0">
                        <img src="/admin/images/users/avatar-3.jpg" class="img-fluid me-2 avatar-sm rounded-circle"
                          alt="avatar-3" />
                      </div>
                      <div class="flex-grow-1">
                  ...
                  <a href="javascript:void(0);" class="dropdown-item py-3 border-bottom">
                    <div class="d-flex">
                      <div class="flex-shrink-0">
                        <img src="/admin/images/users/avatar-5.jpg" class="img-fluid me-2 avatar-sm rounded-circle"
                          alt="avatar-5" />
                      </div>
                      <div class="flex-grow-1">
            ...
            <div class="position-relative ms-2">
                ...
                <div class="mb-4">
                  ...
                  <div class="ms-2">
                    ...
                    <p class="d-flex align-items-center mb-0">Marked<span
                      ...
                      </span> as <span class="badge bg-success-subtle text-success px-2 py-1 ms-1"> Completed</span></p>
              ...
              <div class="position-relative ps-4">
                <div class="mb-4">
                  ...
                  <div class="ms-2">
                    ...
                    <p>Get access to over 20+ pages including a dashboard layout, charts, kanban board, calendar, and
                ...
                <div class="mb-4">
                  <span
                    class="position-absolute start-0 translate-middle-x bg-success bg-gradient d-inline-flex align-items-center justify-content-center rounded-circle text-light fs-20"><img
                      src="/admin/images/users/avatar-7.jpg" alt="avatar-5" class="avatar-sm rounded-circle"></span>
                  <div class="ms-2">
              ...
              <div class="position-relative ps-4">
                <div class="mb-4">
                  <span
                    class="position-absolute start-0 translate-middle-x bg-success bg-gradient d-inline-flex align-items-center justify-content-center rounded-circle text-light fs-20"><img
                      src="/admin/images/users/avatar-6.jpg" alt="avatar-5" class="avatar-sm rounded-circle"></span>
                  <div class="ms-2">
                    <h5 class="mb-0 text-dark fw-semibold fs-15 lh-base">Rebecca J. added a new team member
                    </h5>
                    <p class="d-flex align-items-center gap-1">
                      <iconify-icon icon="iconamoon:check-circle-1-duotone" class="text-success"></iconify-icon> Added a
                ...
                <div class="mb-4">
                  ...
                  <div class="ms-2">
                    ...
                    <p class="d-flex align-items-center gap-1 mt-1">Earned a <iconify-icon
                        icon="iconamoon:certificate-badge-duotone" class="text-danger fs-20"></iconify-icon>" Best
                      Product Award"</p>
    ...
    <div class="main-nav">
      ...
      <div class="logo-box">
        <a href="index.html" class="logo-dark">
          <img src="/admin/images/logo-sm.png" class="logo-sm" alt="logo sm">
          <img src="/admin/images/logo-dark.png" class="logo-lg" alt="logo dark">
        </a>

        <a href="index.html" class="logo-light">
          <img src="/admin/images/logo-sm.png" class="logo-sm" alt="logo sm">
          <img src="/admin/images/logo-light.png" class="logo-lg" alt="logo light">
        </a>
      </div>
                    ...
                    <div class="row">
                      <div class="col-6">
                        <div class="avatar-md bg-soft-primary rounded">
                          <iconify-icon icon="solar:cart-5-bold-duotone" class="avatar-title fs-32 text-primary">
                          </iconify-icon>
                        </div>
                      </div> <!-- end col -->
                ...
                <table class="table mb-0">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>29 April 2024</td>
                      <td>
                        <img src="/admin/images/products/product-1(1).png" alt="product-1(1)"
                    ...
                    <tr>
                      ...
                      <td>25 April 2024</td>
                      <td>
                        <img src="/admin/images/products/product-4.png" alt="product-4" class="img-fluid avatar-sm">
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>25 April 2024</td>
                      <td>
                        <img src="/admin/images/products/product-5.png" alt="product-5" class="img-fluid avatar-sm">
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>21 April 2024</td>
                      <td>
                        <img src="/admin/images/products/product-6.png" alt="product-6" class="img-fluid avatar-sm">
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>18 April 2024</td>
                      <td>
                        <img src="/admin/images/products/product-1(2).png" alt="product-1(2)"
                          class="img-fluid avatar-sm">
                      </td>
                      <td>
  ...
  <!-- Vector Map Js -->
  <script src="/admin/vendor/jsvectormap/js/jsvectormap.min.js"></script>
  <script src="/admin/vendor/jsvectormap/maps/world-merc.js"></script>
  <script src="/admin/vendor/jsvectormap/maps/world.js"></script>
